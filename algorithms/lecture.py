...
def _has_academic_motion(segment: dict) -> bool:
    return has_motion(segment, fields=_ACADEMIC_MOTION_FIELDS, words=ACADEMIC_MOTION_WORDS)


def _looks_generic(segment: dict) -> bool:
    return looks_generic(segment, GENERIC_LECTURE_PHRASES)
